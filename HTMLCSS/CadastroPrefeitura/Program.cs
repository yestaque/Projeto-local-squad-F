...
{
    var connectionString = builder.Configuration.GetConnectionString("cadastrar.prefeitura");
    return new MongoClient("mongodb+srv://gabrielbacelar1000:admin@cluster0.ncfho.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
});
...
{
    app.UseDeveloperExceptionPage(); // Exibe informações detalhadas no ambiente de desenvolvimento
}
...
public class CadastroController : Controller
{
    ...
    [HttpPost]
    public async Task<IActionResult> Prosseguir(string CNPJ, string CNES, string Endereco, string NomePrefeitura, string NumeroConvenio, string ResponsavelPrefeitura, string TelefoneResponsavel, string EmailResponsavel)
    {
